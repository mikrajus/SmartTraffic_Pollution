    ...
    datasets: [
      {
        ...
        tension: 0.3,
        pointBackgroundColor: "#e3a127", // supaya titik juga kelihatan
      },
    ],
  },
  options: {
    ...
    plugins: {
      legend: {
        display: false,
        labels: {
          color: "white" // warna teks legenda (jika diaktifkan)
        }
      },
      tooltip: {
        bodyColor: "white",
    ...
    scales: {
      x: {
        ...
        grid: {
          color: "rgba(255,255,255,0.1)" // opsional: warna grid X
        }
      },
      y: {
        ticks: {
        ...
        grid: {
          color: "rgba(255,255,255,0.1)" // opsional: warna grid Y
        }
      }
    }
  },
